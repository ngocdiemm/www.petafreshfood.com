    ...
    <section class="container">
            ...
            <div class="contact-form">
                <form action="submit_form.php" method="post">
                    ...
                    <label for="name"><p>Họ tên</p></label></br>
                    <input type="text" id="name" name="name" required></br>
    
                    <label for="phone"><p>Số điện thoại</p></label></br>
                    <input type="tel" id="phone" name="phone" required></br>
    
                    <label for="address"> <p>Địa chỉ nhận hàng</p></label></br>
                    <textarea id="address" name="address" rows="4" required></textarea></br>
    
                    <label for="delivery-time"> <p>Thời gian giao hàng mong muốn</p> </label></br>
                    <input type="text" id="delivery-time" name="delivery-time" required></br>
    
                    <label for="payment-method"><p>Phương thức thanh toán</p> </label></br>
                    <input type="text" id="payment-method" name="payment-method" required></br>
